...
public class JGraphEditor extends DefaultScrollPane implements GenericModelEditor {
    ...
    public void initExportEntries(ResourceHelperProvider aProvider, DefaultMenu aExportMenu) {
        ...
        DefaultAction theExportPDFAction = new DefaultAction(aProvider, ERDesignerBundle.ASPDF);
        DefaultMenu thePDFExportMenu = new DefaultMenu(theExportPDFAction);
        aExportMenu.add(thePDFExportMenu);
        addExportEntries(thePDFExportMenu, new PDFExporter());
